      ...
      newDomPossibleAnswers.push(
        <div key={this.state.answerCount} className="form-group">
          <input
            ...
            className="form-control possible-answer"
            type="text"
            placeholder="Answer"
          />
          <label>
            <input name="isCorrect" type="checkbox" /> Is correct
          </label>
        </div>
      )
            ...
            <form>
              ...
              <div>
                <input
                  ...
                  name="questionType"
                  value="single"
                  onClick={this.questionTypeInput}
                />
                  ...
                  <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        type="radio"
                        name="correctAnswer"
                        value={this.state.formQuestionData.possibleChoices[0]}
                        onClick={this.handleQuestionFormChange}
                      />
                      <label htmlFor="answer1">This answer is correct</label>
                    </div>
                    <div className="form-group">
                      <input
                        onChange={this.multipleChoice2}
                        type="text"
                        name="answer"
                        className="form-control"
                      ...
                      <input
                        ...
                        type="radio"
                        name="correctAnswer"
                        value={this.state.formQuestionData.possibleChoices[1]}
                        onClick={this.handleQuestionFormChange}
                      />
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        type="radio"
                        name="correctAnswer"
                        value={this.state.formQuestionData.possibleChoices[2]}
                        onClick={this.handleQuestionFormChange}
                      />
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        type="radio"
                        name="correctAnswer"
                        value={this.state.formQuestionData.possibleChoices[3]}
                        onClick={this.handleQuestionFormChange}
                      />
